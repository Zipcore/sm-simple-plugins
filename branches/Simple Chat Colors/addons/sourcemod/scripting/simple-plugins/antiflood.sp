...
new Float:max_chat;
new Handle:scc_flood_time;								/* Handle to scc_flood_time convar */

InitAntiFlood()
{
	scc_flood_time = CreateConVar("scc_flood_time", "0.75", "Amount of time allowed between chat messages");
}
...
{
	max_chat = GetConVarFloat(scc_flood_time);
